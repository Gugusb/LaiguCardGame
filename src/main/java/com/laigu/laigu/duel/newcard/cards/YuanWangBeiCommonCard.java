...
/** 破阵·越杯（普通）：破阵成功（本槽骰面和 > 对手同槽）→ 削弱对手该槽位 50%。 */
public final class YuanWangBeiCommonCard implements DuelCard, NewSettlementCalculator.PoZhenHandler, OnPoZhen
{
    @Override public String id() { return "yuan_wang_bei_common"; }
