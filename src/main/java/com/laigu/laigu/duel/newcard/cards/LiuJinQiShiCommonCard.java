...
/** 盛象·鎏金骑士（普通）：若你有金质卡 → +1 倍率。 */
public final class LiuJinQiShiCommonCard implements DuelCard, OnSettlement
{
    @Override public String id() { return "liu_jin_qi_shi_common"; }
