...
/** 天王实刻普通版：若你的骰全大(≥4) → +3 倍率。 */
public final class TianWangShiKeCommonCard implements DuelCard, OnSettlement
{
    @Override public String id() { return "tian_wang_shi_ke_common"; }
