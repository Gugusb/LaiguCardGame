...
/** 鎏金·金蝉玉叶（金质）：每颗放在金质卡上的骰 → +2 倍率。 */
public final class JinChanYuYeGoldCard implements DuelCard, OnSettlement
{
    @Override public String id() { return "jin_chan_yu_ye_gold"; }
