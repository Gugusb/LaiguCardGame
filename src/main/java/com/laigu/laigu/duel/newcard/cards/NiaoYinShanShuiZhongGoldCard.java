...
/** 鸟音山水钟（金质）：重骰——抓骰时重骰共享池 > 抓取点数的骰（本轮限 2 次）。 */
public final class NiaoYinShanShuiZhongGoldCard implements DuelCard
{
    @Override public String id() { return "niao_yin_shan_shui_zhong_gold"; }
    ...
    private int rerollLimit() { return 2; }
