...
/** 五星出东方（金质）：本卡每颗 ≤3 骰 → +12/+24 额外分。 */
public final class WuXingChuDongFangGoldCard implements DuelCard, OnSettlement
{
    @Override public String id() { return "wu_xing_chu_dong_fang_gold"; }
