...
/** 莫高窟记普通版：若你的骰全小(≤3) → +30 额外分。 */
public final class MoGaoKuJiCommonCard implements DuelCard, OnSettlement
{
    @Override public String id() { return "mo_gao_ku_ji_common"; }
