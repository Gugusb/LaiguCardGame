...
/** 桃园仙境图普通版：连续在场 ≥2 轮 → +16 额外分。 */
public final class TaoYuanXianJingTuCommonCard implements DuelCard, OnSettlement
{
    @Override public String id() { return "tao_yuan_xian_jing_tu_common"; }
