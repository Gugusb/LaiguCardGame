...
/** 三兔藻井（普通）：本卡每颗偶数骰 → +8/+16 额外分。 */
public final class SanTuZaoJingCommonCard implements DuelCard, OnSettlement
{
    @Override public String id() { return "san_tu_zao_jing_common"; }
