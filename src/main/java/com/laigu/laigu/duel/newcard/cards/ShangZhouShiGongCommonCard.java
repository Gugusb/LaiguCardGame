...
/** 商周十供普通版：对手放置骰比你多 → +15 额外分。 */
public final class ShangZhouShiGongCommonCard implements DuelCard, OnSettlement
{
    @Override public String id() { return "shang_zhou_shi_gong_common"; }
